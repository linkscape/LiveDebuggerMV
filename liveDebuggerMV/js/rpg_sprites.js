...
Sprite_Timer.prototype.createBitmap = function() {
    this.bitmap = new Bitmap(288, 96);
    this.bitmap.fontSize = 64;
    this.bitmap.fontColor = "red"
};
...
Sprite_Timer.prototype.updateBitmap = function() {
    if (this._frames !== $gameTimer._frames) {
...
Sprite_Timer.prototype.timerText = function() {
    ...
    var fr = this._frames % 60;
    return min.padZero(2) + ':' + sec.padZero(2) +'.'+ fr.padZero(2);
};
